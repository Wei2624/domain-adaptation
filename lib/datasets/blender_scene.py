...
class blender_scene(datasets.imdb):
    def __init__(self, image_set, blender_scene_path = None):
        datasets.imdb.__init__(self, 'blender_scene_' + image_set)
        self._image_set = image_set
        self._blender_scene_path = self._get_default_path() if blender_scene_path is None \
                            else blender_scene_path
        self._data_path = os.path.join(self._blender_scene_path, 'data')
        ...
        assert os.path.exists(self._blender_scene_path), \
                'blender_scene path does not exist: {}'.format(self._blender_scene_path)
    ...
    def _load_image_set_index(self):
        ...
        """
        image_set_file = os.path.join(self._blender_scene_path, self._image_set + '.txt')
    ...
    def _get_default_path(self):
        ...
        """
        return os.path.join(datasets.ROOT_DIR, 'data', 'BlenderScene')
    ...
    def gt_roidb(self):
        ...
        gt_roidb = [self._load_blender_scene_annotation(index)
    ...
    def _load_blender_scene_annotation(self, index):
        """
